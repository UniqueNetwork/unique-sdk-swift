//
//  CollectionCreateBuildRequest.swift
//  UniqueSDK
//
...
struct CollectionCreateBuildRequest: IRequest {
    
    // MARK: - Properties
    
    private let requestParameters: UNQRequestParameters
    private let requestBody: UNQCreateColletionBody
    
    // MARK: - Initialization
    
    public init(parameters: UNQRequestParameters, body: UNQCreateColletionBody) {
